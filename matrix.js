...
export function matMul(m1,m2) {
        ...
        tmp[2] = m1[0] * w + m1[1] * m2[6] + m1[2] * m2[10] + m1[3] * m2[14];
        tmp[6] = m1[4] * w + m1[5] * m2[6] + m1[6] * m2[10] + m1[7] * m2[14];
        tmp[10] = m1[8] * w + m1[9] * m2[6] + m1[10] * m2[10] + m1[11] * m2[14];
        tmp[14] = m1[12] * w + m1[13] * m2[6] + m1[14] * m2[10] + m1[15] * m2[14];
