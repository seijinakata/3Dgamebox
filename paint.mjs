...
export function triangleToBuffer(renderZBuffer,triangleZ,textureAlpha,img, vertex_list, uv_list)
{
  ...
  if (vertex_list[2] > 0.0 && vertex_list[5] > 0.0 && vertex_list[8] > 0.0) {
	...
	let minYmaxY = dotLineBufferRegister(vertex_list[0],vertex_list[3],vertex_list[1],vertex_list[4],0,255,255,255,triangleFrame);//0から1
	let minY = minYmaxY[0],maxY = minYmaxY[1];

	minYmaxY = dotLineBufferRegister(vertex_list[3],vertex_list[6],vertex_list[4],vertex_list[7],0,255,255,255,triangleFrame);//1から3
	if(minY>minYmaxY[0]){
		minY = minYmaxY[0];
	}
	if(maxY<minYmaxY[1]){
	...
	minYmaxY = dotLineBufferRegister(vertex_list[6],vertex_list[0],vertex_list[7],vertex_list[1],0,255,255,255,triangleFrame);//3から0
	if(minY>minYmaxY[0]){
		minY = minYmaxY[0];
	}
	if(maxY<minYmaxY[1]){
