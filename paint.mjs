...
import { setVector3 } from "./vector.js";
...
export function textureTransform(a,b,c,d,h,w,alpha,imageData,screen_size_h,screen_size_w,clipMinY,clipMaxY,bufferFrame,
				...
				if(shadowMap !=null){
					...
					if(pixelVector3[0]>0 && pixelVector3[0]<SCREEN_SIZE_W){
						if(pixelVector3[1]>0 && pixelVector3[1]<SCREEN_SIZE_H){
							if(shadowMap[pixelVector3[1]][pixelVector3[0]].get().getPixel().z+0.125<pixelVector3[2]){
...
export function triangleToBuffer(renderZBuffer,shadowMap,inverseViewMatrix,inverseViewPortMatrix,sunViewMatrix,viewPortMatrix,textureAlpha,img, vertex_list, uv_list)
{
  ...
  if (vertex_list[2] > 0.0 && vertex_list[5] > 0.0 && vertex_list[8] > 0.0) {
	...
	textureTransform(a,b,c,d,vertex_list[1]
	 - (b * uv_list[0] * img.width + d * uv_list[1] * img.height), vertex_list[0] - (a * uv_list[0] * img.width + c * uv_list[1] * img.height),textureAlpha,img,SCREEN_SIZE_H,SCREEN_SIZE_W,minY,maxY,triangleFrame,
	 renderZBuffer,shadowMap,inverseViewMatrix,inverseViewPortMatrix,sunViewMatrix,viewPortMatrix);
