...
export function triangleToBuffer(renderZBuffer, img, vertex_list, uv_list)
{
...
dotLineBufferRegister(vertex_list[0],vertex_list[2],vertex_list[1],vertex_list[3],0,255,255,255,triangleFrame);//0から1
dotLineBufferRegister(vertex_list[2],vertex_list[4],vertex_list[3],vertex_list[5],0,255,255,255,triangleFrame);//1から3
dotLineBufferRegister(vertex_list[4],vertex_list[0],vertex_list[5],vertex_list[1],0,255,255,255,triangleFrame);//3から0

triangleRasterize(triangle,triangleFrame,1,255,0,0,255,SCREEN_SIZE_H,SCREEN_SIZE_W);

let affinedTexture = textureTransform(a,b,c,d,vertex_list[1]
 - (b * uv_list[0] * img[0].length + d * uv_list[1] * img.length), vertex_list[0] - (a * uv_list[0] * img[0].length + c * uv_list[1] * img.length),img,SCREEN_SIZE_H,SCREEN_SIZE_W);
