...
export function triangleToBuffer(renderZBuffer,triangleZ,textureAlpha,img, vertex_list, uv_list)
{
  ...
  if (vertex_list[2] > 0.0 && vertex_list[5] > 0.0 && vertex_list[8] > 0.0) {
	...
	//頂点はコの字の並び
	dotLineBufferRegister(vertex_list[0],vertex_list[3],vertex_list[1],vertex_list[4],0,255,255,255,triangleFrame);//八の字の左側
	dotLineBufferRegister(vertex_list[3],vertex_list[6],vertex_list[4],vertex_list[7],0,255,255,255,triangleFrame);//左上から右下。
	dotLineBufferRegister(vertex_list[6],vertex_list[0],vertex_list[7],vertex_list[1],0,255,255,255,triangleFrame);//八の字の右側
