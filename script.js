...
class Polygon{
  //左上、左下、右下、右上の順
  constructor(Pos1,Pos2,Pos3,Pos4,num,image){
    this.isdraw = false;
    this.moveVertices = [];
...
class Cube{
  ...
  constructor(x,y,z,extension,deg,num,state,imgName){
    this.x = x;
    this.y = y;
    this.z = z;
...
class Shpere{
  ...
  constructor(x,y,z,extension,numCorners,turnDeg,turnState,imgName){
    //numVertices分入れる
    this.x = x;
    this.y = y;
    this.z = z;
...
let cubes = [];
cubes.push(new Cube(500,150,5,350,0,8,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Cube(150,150,7,250,0,8,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F18735737.jpg?v=1621134617587'));
cubes.push(new Cube(700,700,3,250,0,8,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F18735737.jpg?v=1621134617587'));

//頂点数は偶数で
let spheres = [];
spheres.push(new Shpere(400,500,5,350,12,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
spheres.push(new Shpere(500,150,4,350,24,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
...
function draw(cubes,spheres){
  ...
  for(let num =0;num<spheres.length;num++){
    let sphereImage = spheres[num].image;
