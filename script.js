...
var img = new Image();
img.src = '0473fc3d55a213710b0b024a2fdc3a51';
...
drawTriangle(con, img, 
	[
	 Polygones[0].moveVertices[0].x, Polygones[0].moveVertices[0].y,
	 Polygones[0].moveVertices[2].x, Polygones[0].moveVertices[2].y,
	 Polygones[0].moveVertices[1].x, Polygones[0].moveVertices[1].y,
	],
	[
	 0, 0,
	 1, 0,
...
drawTriangle(con, img, 
	[
	 Polygones[0].moveVertices[1].x, Polygones[0].moveVertices[1].y,
	 Polygones[0].moveVertices[3].x, Polygones[0].moveVertices[3].y,
	 Polygones[0].moveVertices[2].x, Polygones[0].moveVertices[2].y,
	],
	[
	 0   , 1,
