...
class Cube{
  ...
  if(this.deg>360){
    ...
    for(let i=0;i<this.num;i++){
      ...
      this.dotMovePos[i].z+= this.z+moveZ;
      //dotMovePos[i].z = 5;
      ...
      //移動
      this.dotMovePos[i].x += this.x+moveX;
      this.dotMovePos[i].y += this.y+moveY;
    }
  }
}
let cubes = [];
cubes.push(new Cube(500,500,5,350,0,8,0));
cubes.push(new Cube(350,350,10,250,0,8,0));
