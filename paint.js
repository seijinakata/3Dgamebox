        ...
        do{
            ...
            if(z>sz){
				if(shadowMap !=null){
					...
					let affinedPixel = setPixel(orgTexture.data[index],orgTexture.data[index + 1],orgTexture.data[index + 2],orgTexture.data[index + 3]);
					//camera
					...
					if(pixelVector3[0]>0 && pixelVector3[0]<SCREEN_SIZE_W){
						if(pixelVector3[1]>0 && pixelVector3[1]<SCREEN_SIZE_H){
							if(shadowMap[pixelVector3[1]][pixelVector3[0]].getZ()+0.07<pixelVector3[2]){
