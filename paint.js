...
function scan_horizontal(zBuffering,screen_size_w,y,se,iA,h,w,imageData,shadowMap){
...
export function triangleToBuffer(zBuffering,shadowMap,textureAlpha,img,vertex_list,uv_list)
{
  //各点のZ座標がこれより下なら作画しない。
