...
class Polygon{
  ...
  BufferRegister(renderZBuffer,shadowMap,inverseViewMatrix,inverseViewPortMatrix,sunViewMatrix,viewPortMatrix){
	triangleToBuffer(renderZBuffer,shadowMap,inverseViewMatrix,inverseViewPortMatrix,sunViewMatrix,viewPortMatrix,1,this.image,
        [
...
function objectPolygonPush(objects,objectNumber,moveObjects,viewMatrix){
  ...
  for (var i = 0; i < object.verts.length; i++) {
    ...
    let projectionViewPortMatrix = matMul(viewPortMatrix,projectionMatrix);
    worldVerts[i] = matVecMul(projectionViewPortMatrix,worldVerts[i]);
...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,-1.0,-0.55,1.5,0,0,0,1,1,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,cubePixelImage));
  cubes.push(new Object(orgCubeVerts,-1.0,-1.1,2.0,0,0,0,1,1,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
	...
	cubes.push(new Object(orgCubeVerts,1.5,-0.35,2,0,0,0,1,1,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
...
roadImage.addEventListener("load", function() {
  ...
  planes.push(new Object(orgPlaneVerts,0,0,0.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,roadPixelImage));
  planes.push(new Object(orgPlaneVerts,0,0,1.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,roadPixelImage));
  planes.push(new Object(orgPlaneVerts,0,0,2.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,roadPixelImage));
  planes.push(new Object(orgPlaneVerts,0,0,3.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,roadPixelImage));
...
groundImage.addEventListener("load", function() {
  ...
  planes.push(new Object(orgPlaneVerts,-1.25,0,0.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,-1.25,0,1.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,-1.25,0,2.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,-1.25,0,3.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,1.25,0,0.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,1.25,0,1.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,1.25,0,2.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
  planes.push(new Object(orgPlaneVerts,1.25,0,3.0,0,0,0,2.5,1,2,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,sandPixelImage));
...
//lookat = setVector3(moveObjects[lookatIndex].orgObject.centerObjX,moveObjects[lookatIndex].orgObject.centerObjY,moveObjects[lookatIndex].orgObject.centerObjZ);
  ...
  let inverseViewMatrix = getInverseMatrix(viewMatrix);
