...
function objectPolygonPush(objects,objectNumber,moveObjects,viewMatrix){
  ...
  for (var i = 0; i < object.verts.length; i++) {
    ...
    worldVerts[i][0] = Math.floor(worldVerts[i][0] + 0.5);
    worldVerts[i][1] = Math.floor(worldVerts[i][1] + 0.5);
  }
...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,-0.0,-0.55,2.5,0,60,0,1,1,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
