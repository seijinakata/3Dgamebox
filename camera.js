...
//viewPortMat
export let viewPortMatrix = [
  [ SCREEN_SIZE_W, 0, 0, SCREEN_SIZE_W/2],
  [ 0, SCREEN_SIZE_H, 0, SCREEN_SIZE_H/2],
  [ 0, 0, 1, 0],
  [ 0, 0, 0, 1]
];
export let inverseViewPortMatrix = getInverseMatrix(viewPortMatrix);
export let viewMatrix = matIdentity();
export let inverseViewMatrix = matIdentity();
export let sunViewMatrix = matIdentity();
// Camera
