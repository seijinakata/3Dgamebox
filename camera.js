...
import {matIdentity,mulMatTranslate,mulMatScaling, matMul,matVecMul,matPers,matCamera,mulMatRotateX,mulMatRotateY,mulMatRotateZ} from './matrix.js';
...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,-1.0,-0.35,2,0,0,0,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
