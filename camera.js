...
let cube2 = new Object(orgCubeVerts,-0,0,4.5,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube3 = new Object(orgCubeVerts,0,-1.5,5.0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
  ...
  for(let i=1;i<cubes.length;i++){
    ...
    if(!moveObjects[i].preGravityCollision){
      ...
      if(moveObjects[i-1].centerObjY<moveObjects[i].centerObjY){
        upObject = moveObjects[i-1];
      }else{
        upObject = moveObjects[i];
      }
      let upObjectY = Math.floor(upObject.centerObjY*10)/10;
      console.log(upObjectY)
    }
  }
