...
function renderbufferInit(buffer,pixelX,pixelY){
...
let pixel = setPixel(3,0,0,0,0);
if(pixel.z<zBuffering[0][0][0].z){
  zBuffering[0][0].splice(0,1,pixel);
}
//console.log(zBuffering[0][0][0])
