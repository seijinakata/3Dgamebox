...
import {pixel,bufferPixelInit,pictureToPixelMap,dotPaint,dotLineBufferRegister,triangleRasterize} from './paint.mjs';
...
let orgTexture = [];
orgTexture = roadPixelImage;
let affinedTexture = [];
affinedTexture = bufferPixelInit(SCREEN_SIZE_H,SCREEN_SIZE_W);
...
let e = 0;//横移動、transform関数のe
let f = 0;//縦移動、transform関数のf
let det = 0;//逆行列のad-bc
