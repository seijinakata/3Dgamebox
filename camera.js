...
// Camera
let cameraPos = setVector3(0,-4,-3);
let lookat = setVector3(0.0,-0.0,0);
...
monkeysImage.addEventListener("load", function() {
	...
	let uv = [];
	let faceUV = [];
	monkeys.push(new Object(monkeyVerts,0.0,-0.6,2,-180,0,0,0.5,0,faceIndex,uv,faceUV,false,true,monkeyPixelImage));
...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,-1.0,-0.55,1.5,0,0,0,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,false,cubePixelImage));
  cubes.push(new Object(orgCubeVerts,-1.0,-1.1,2.0,0,0,0,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
	...
	cubes.push(new Object(orgCubeVerts,1.5,-0.35,2,0,0,0,1,0,cubeFaceIndex,cubePlaneUV,cubeFaceUV,false,true,cubePixelImage));
