...
import {pixel,dotPaint,dotLineBufferRegister,dotLinePaint} from './paint.mjs';
...
let Xs = SCREEN_SIZE_W/2;
let Ys = SCREEN_SIZE_H/2;
let Xe1 = SCREEN_SIZE_W/2+90;
let Ye1 = SCREEN_SIZE_H/2+200;

let Xe = SCREEN_SIZE_W/2-90;
let Ye = SCREEN_SIZE_H/2+200;
...
for(let j=0;j<SCREEN_SIZE_H;j++){
	...
	triangle.push(tempPixel);
}

dotLinePaint(Xs,Xe1,Ys,Ye1,255,0,0,255,ctx);

dotLineBufferRegister(Xs,Xe,Ys,Ye,0,0,255,255,triangle);
