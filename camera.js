...
let spheres = [];
spheres.push(new Object(sphereVerts,-0.6,-0.26,4.9,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));

let cubes = [];
//一番下は-0.26から積み重ねる場合+0.5
cubes.push(new Object(orgCubeVerts,-0.6,-0.26,4.9,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,0.6,-0.26,5.0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
...
cubes.push(new Object(orgCubeVerts,0.6,-0.76,5,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,0.0,-0.26,8,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,-1.5,-0.26,3,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,1.5,-0.26,4,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));

let planes = [];

for(let j=0;j<2;j++){
  for(let i=0;i<9;i++){
    planes.push(new Object(orgPlaneVerts,-0.5+1.0*j,0,1.5+1.0*i,-90,0,0,false,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fkon.webp?v=1628567425337'));
  }
}
for(let j=0;j<3;j++){
  for(let i=0;i<9;i++){
    planes.push(new Object(orgPlaneVerts,-1.5-1.0*j,0,1.5+1.0*i,-90,0,0,false,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fsand1.jpg?v=1628733452373'));
  }
}
for(let j=0;j<3;j++){
  for(let i=0;i<9;i++){
...
var mainLoopId = setInterval(function(){
  ...
  projectionList = setProjectionMatrix(spheres[0],Cz,Cx,Cy);
    ...
    distance_from_Obj_to_Camera = projectionList.distance_from_Obj_to_Camera;
    var moveCubeInfo = [];
    moveCubeInfo = cameraModel(spheres[0],distance_from_Obj_to_Camera,ORz,ORy,ORx,CRz,CRy,CRx,Extension,offset);
    console.log(moveCubeInfo)
