...
let cube1 = new Object(orgCubeVerts,6,2,5,0,0,0,0,0,0,300,300,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
...
let cube3 = new Object(orgCubeVerts,-7,2,5,0,0,0,0,0,0,300,300,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
...
function cameraModel(data,G,Rz,Ry,Rx,OzCz,OxOy,CxCy,Extension) {
  var result = [];
...
var mainLoopId = setInterval(function(){
  ...
  for(let num=0;num<planes.length;num++){
    ...
    var moveplaneInfo = [];
    moveplaneInfo = cameraModel(plane,G,Rz,Ry,Rx,OzCz,OxOy,CxCy,Extension);
  ...
  for(let num=0;num<cubes.length;num++){
    ...
    var moveCubeInfo = [];
    moveCubeInfo = cameraModel(cube,G,Rz,Ry,Rx,OzCz,OxOy,CxCy,Extension);
