...
//おなじにすると作画が変になる。
let cube1 = new Object(orgCubeVerts,0,1,4.3,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube2 = new Object(orgCubeVerts,0,0.5,4.0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
  ...
  while(true){
    let drawObjectNum = -1;
     if((40<=CRotY && CRotY<=120) || (220<=CRotY && CRotY<=320)){
      ...
      /*if(moveObjects[drawObjectNum].centerObjY-Cy>=0){
        for(let i=0;i<moveObjects.length;i++){
         if(drawObjectNum != i){
