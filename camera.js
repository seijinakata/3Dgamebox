...
let cube1 = new Object(orgCubeVerts,-1.0,0,5,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube2 = new Object(orgCubeVerts,0,0,9,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube3 = new Object(orgCubeVerts,1.0,0,7,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');

let plane1 = new Object(orgPlaneVerts,0,0,4,-90,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F60a394aea133b1704cfd2d6e5db73daf.jpg?v=1623199958814');
let plane2 = new Object(orgPlaneVerts,0,0,6,-90,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F60a394aea133b1704cfd2d6e5db73daf.jpg?v=1623199958814');
let plane3 = new Object(orgPlaneVerts,0,0,8,-90,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F60a394aea133b1704cfd2d6e5db73daf.jpg?v=1623199958814');
...
var mainLoopId = setInterval(function(){
  ...
  for(let num=0;num<planes.length;num++){
    ...
    collisionPlanes.push(moveplaneVerts);
  }
  console.log(collisionPlanes)
  //cube
  for(let num=0;num<cubes.length;num++){
    ...
    collisionCubes.push(moveCubeVerts);
  }
  console.log(collisionCubes);
    //移動後の情報格納
  let moveObjects = [];
