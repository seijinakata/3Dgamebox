...
let cube1 = new Object(orgCubeVerts,6,2,5,0,0,0,0,0.5,0,300,300,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube2 = new Object(orgCubeVerts,0,2,5,0,0,0,0,0,0,300,300,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube3 = new Object(orgCubeVerts,-6,2,5,0,0,0,0,-0.5,0,300,300,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');

let plane1 = new Object(orgPlaneVerts,-0.8,-1,5,0,0,0,0,0,0,1500,1500,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F60a394aea133b1704cfd2d6e5db73daf.jpg?v=1623199958814');
...
function cameraModel(data,G,Rz,Ry,Rx,OzCz,CxCy,Extension) {
  var result = [];
...
function setProjectionMatrix(object,offsetX,offsetY,Cz,Cx,Cy){
  let projectionList = [];
    ...
    let CxCy = 
      [
      [ 1, 0, 0, (object.objX -Cx)/(object.objZ-Cz) ],
      [ 0, 1, 0, (object.objY -Cy)/(object.objZ-Cz)  ],
      [ 0, 0, 1, 0  ],
      [ 0, 0, 0, 1 ]
    ];
...
var mainLoopId = setInterval(function(){
  ...
  for(let num=0;num<planes.length;num++){
    ...
    var moveplaneInfo = [];
    moveplaneInfo = cameraModel(plane,G,Rz,Ry,Rx,OzCz,CxCy,Extension)
  ...
  for(let num=0;num<cubes.length;num++){
    ...
    var moveCubeInfo = [];
    moveCubeInfo = cameraModel(cube,G,Rz,Ry,Rx,OzCz,CxCy,Extension)
