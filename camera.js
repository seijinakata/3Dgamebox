...
backCtx.width = SCREEN_SIZE_W;
backCtx.height = SCREEN_SIZE_H;
...
for(let j=0;j<roadPixelImage.length;j++){
	for(let i=0;i<roadPixelImage[0].length;i++){
	let getPixel = roadPixelImage[j][i].getPixel();
