...
class moveObject{
  ...
  constructor(verts){
    ...
    this.moveObjinfo = verts;
    let tempobjX = 0;
    for(let i=0;i<orgCubeVerts.length;i++){
    ...
    this.centerObjX = tempobjX/orgCubeVerts.length;
    this.centerObjY = tempobjY/orgCubeVerts.length;;
    this.centerObjZ = tempobjZ/orgCubeVerts.length;;
...
let a = new moveObject(orgCubeVerts,0,0,0,0);
...
var mainLoopId = setInterval(function(){
  ...
  for(;num<cubes.length+planes.length;num++){
    ...
    let a = new moveObject(moveCubeInfo);
    console.log(a)
