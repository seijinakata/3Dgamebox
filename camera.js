...
var mainLoopId = setInterval(function(){
  ...
  for(let i=1;i<cubes.length;i++){
    ...
    let projectionList = [];
    projectionList = setProjectionMatrix(cubes[upIndex],Cz,Cx,upObjectY,CRotZ,CRotX,CRotY);
    ...
    distance_from_Obj_to_Camera = projectionList.distance_from_Obj_to_Camera;
    var moveCubeInfo = [];
    moveCubeInfo = cameraModel(cubes[upIndex],distance_from_Obj_to_Camera,ORz,ORy,ORx,CRz,CRy,CRx,Extension,offset);
