...
var rgba = context.getImageData(img.width/2, img.height/2,1,1).data;
console.log(rgba);
canvas.hidden = false;
...
skyImage.src = 'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fwallpaper_00460.jpg?v=1629701157820';
spheres.push(new Object(sphereVerts8,0.0,0.0,5,0,0,0,16,true,false,skyImage));

let cubes = [];
let cubeImage = new Image();
cubeImage.src = 'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541';
//一番下は-0.26から積み重ねる場合+0.5
cubes.push(new Object(orgCubeVerts,-0.6,-0.26,4.9,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,0.6,-0.26,5.0,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,-0.6,-0.76,5.0,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,0.6,-0.76,5,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,0.0,-0.26,8,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,-1.5,-0.26,3,0,0,0,0,false,true,cubeImage));
cubes.push(new Object(orgCubeVerts,1.5,-0.26,4,0,0,0,0,false,true,cubeImage));

let planes = [];
let roadImage = new Image();
roadImage.src = 'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fkon.webp?v=1628567425337';
for(let j=0;j<2;j++){
  for(let i=0;i<9;i++){
...
groundImage.src = 'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fsand1.jpg?v=1628733452373';
for(let j=0;j<3;j++){
  for(let i=0;i<9;i++){
