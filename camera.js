...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,0.0,-1.0,4.5,0,0,0,0,false,true,cubePixelImage));
	...
	for(let num=0;num<cubes.length;num++){
		...
		moveCubeInfo.backCullingFlag = cube.backCullingFlag;
			...
			for(let i=0;i<model1.faceIndex.length;i++){
			    ...
			    Poly.push(new Polygon(moveCubeInfo[triangleIndex.faceIndex[2]],moveCubeInfo[triangleIndex.faceIndex[1]],moveCubeInfo[triangleIndex.faceIndex[0]],UV,moveCubeInfo.image));
			}
