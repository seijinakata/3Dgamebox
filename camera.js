...
class Polygon{
  ...
  constructor(Pos1,Pos2,Pos3,UV,image){
    ...
    this.image = image;
    this.UV = UV;
    this.centerX = this.moveVertices[0][0]/3 + this.moveVertices[1][0]/3 + this.moveVertices[2][0]/3;
    this.centerY = this.moveVertices[0][1]/3 + this.moveVertices[1][1]/3 + this.moveVertices[2][1]/3;
    this.centerZ = this.moveVertices[0][2]/3 + this.moveVertices[1][2]/3 + this.moveVertices[2][2]/3;
