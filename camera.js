...
import {matIdentity,mulMatTranslate,mulMatScaling, matMul,matVecMul,matPers,matCamera,mulMatRotateX,mulMatRotateY,mulMatRotateZ, getInverseMatrix, matRound4X4, protMatVecMul, CalInvMat4x4} from './matrix.js';
...
//jsonポリゴン製造
function setPolygon(Pos1,Pos2,Pos3,UV,image){
  let polygonElement = {};
  ...
  polygonElement.crossVector3 = culVecCross(Va,Vb);
...
function objectPolygonPush(objects,objectNumber,moveObjects,viewMatrix){
  ...
  for(let i=0;i<object.faceIndex.length;i++){
    ...
    Poly.push(setPolygon(worldVerts[triangleFaceIndex[0]],worldVerts[triangleFaceIndex[1]],worldVerts[triangleFaceIndex[2]],UV,object.image));
  }
