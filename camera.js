...
class Polygon{
  ...
  constructor(Pos1,Pos2,Pos3,UV,image){
    ...
    let vx = Pos1.projX - Pos2.projX;
    let vy = Pos1.projY - Pos2.projY;
    let vector2 = setVector2(vx,vy);
    let Va = vector2;
    //let Va = vecMinus(Pos1,Pos2);
    vx = Pos3.projX - Pos1.projX;
    vy = Pos3.projY - Pos1.projY;
    vector2 = setVector2(vx,vy);
    let Vb = vector2;
...
function objectPolygonPush(objects,objectNumber,moveObjects,viewMatrix){
  ...
  for (var i = 0; i < object.verts.length; i++) {
    ...
    let projX = worldVerts[i][0];
    let projY = worldVerts[i][1];
    ...
    worldVerts[i].projX = projX;
    worldVerts[i].projY = projY;
  }
