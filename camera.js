...
class Object{
  ...
  constructor(verts,x,y,z,RotX,RotY,RotZ,numCorners,backGroundFlag,backCullingFlag,imgName){
...
let sphereVerts8 = makeSphereVerts(8,0.5);
let spheres = [];
//spheres.push(new Object(sphereVerts8,-1.0,-2.0,4.9,0,0,0,16,false,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fdb8f2ca23ac059a599d47a0eb657d462_t.jpg?v=1629512227561'));
spheres.push(new Object(sphereVerts8,0.0,-2.0,4.9,0,0,0,8,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));

let cubes = [];
//一番下は-0.26から積み重ねる場合+0.5
cubes.push(new Object(orgCubeVerts,-0.6,-0.26,4.9,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,0.6,-0.26,5.0,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,-0.6,-0.76,5.0,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,0.6,-0.76,5,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,0.0,-0.26,8,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,-1.5,-0.26,3,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));
cubes.push(new Object(orgCubeVerts,1.5,-0.26,4,0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541'));

let planes = [];

for(let j=0;j<2;j++){
  for(let i=0;i<9;i++){
    planes.push(new Object(orgPlaneVerts,-0.5+1.0*j,0,1.5+1.0*i,-90,0,0,0,false,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fkon.webp?v=1628567425337'));
  }
}
for(let j=0;j<3;j++){
  for(let i=0;i<9;i++){
    planes.push(new Object(orgPlaneVerts,-1.5-1.0*j,0,1.5+1.0*i,-90,0,0,0,false,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fsand1.jpg?v=1628733452373'));
  }
}
for(let j=0;j<3;j++){
  for(let i=0;i<9;i++){
        ...
        if(object.centerObjY<moveObjects[i].centerObjY){
          object.preGravityCollision = AABBcollision(object,moveObjects[i]);
            if(object.preGravityCollision == true){
              ...
              let projectionList  = setProjectionMatrix(object1[upIndex],Cz,Cx,upObjectY);
              ...
              projectionList = setProjectionMatrix(object2[downIndex-object1Length],Cz,Cx,upObjectY);
...
var mainLoopId = setInterval(function(){
  ...
  for(let num =0;num<spheres.length;num++){
    ...
    distance_from_Obj_to_Camera = projectionList.distance_from_Obj_to_Camera;
    var movesphereInfo = [];
    movesphereInfo = cameraModel(sphere,distance_from_Obj_to_Camera,ORz,ORy,ORx,CRz,CRy,CRx,Extension,offset);
      let maxminObject = [];
    let centerX = 0;
    let centerY = 0;
    let centerZ = 0;
    ...
    let maxZ = 0;
    let minZ = 0;
    maxminObject = vertsCulMaxMinCenter(movesphereInfo);
    movesphereInfo.orgObject = spheres[num];
    movesphereInfo.image = sphere.image;
    movesphereInfo.maxX = maxminObject.maxX;
    movesphereInfo.minX = maxminObject.minX;
    movesphereInfo.maxY = maxminObject.maxY;
    movesphereInfo.minY = maxminObject.minY;  
    movesphereInfo.maxZ = maxminObject.maxZ;
    movesphereInfo.minZ = maxminObject.minZ;
    movesphereInfo.centerObjX = sphere.centerObjX;
    movesphereInfo.centerObjY = sphere.centerObjY;
    movesphereInfo.centerObjZ = sphere.centerObjZ;
