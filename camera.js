...
/*
let canvas_hidden = document.getElementById("hiddenCanvas");
canvas_hidden.width = 1000;
canvas_hidden.height = 1000;
...
img.onload = function() {
        ctx_hidden.drawImage(img, 0, 0);
    }
let data = ctx_hidden.getImageData(0, 0, img.width, img.height);
console.log(data)
*/
...
let spheres = [];
spheres.push(new Object(sphereVerts8,0.0,0.0,5,0,0,0,16,true,false,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2Fwallpaper_00460.jpg?v=1629701157820'));
