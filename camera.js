...
monkeysImage.addEventListener("load", function() {
	...
	let uv = [];
	let faceUV = [];
	monkeys.push(new Object(monkeyVerts,0.0,-1.0,4.5,-180,0,0,0.5,0,faceIndex,uv,faceUV,false,true,monkeyPixelImage));
	monkeyLoad = new ModelLoadData(monkeys[0]);
	monkeyLoad.JSONLoader("cube.json", (() => monkeyLoad.onJSONLoaded()));	
}, true);	
...
let cubeUV = [];
cubeUV.push(new UV(0,0));
cubeUV.push(new UV(1,0));
cubeUV.push(new UV(0,1));
cubeUV.push(new UV(1,1));
cubeUV.push(new UV(0,1));
cubeUV.push(new UV(1,0));
...
cubeImage.addEventListener("load", function() {
	...
	cubes.push(new Object(orgCubeVerts,0.0,-1.0,4.5,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,-0.6,-0.4,4.9,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,-0.6,-0.85,5.0,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,0.6,-0.85,5,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,0.6,-0.4,4.9,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,1.5,-0.6,3,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
	//cubes.push(new Object(orgCubeVerts,-1.5,-0.6,4,0,0,0,1,0,cubeFaceIndex,cubeUV,cubeFaceUV,false,true,cubePixelImage));
}, true);
...
if( skyPixelImage.length == 0  || cubePixelImage.length == 0 ||
	roadPixelImage.length == 0 || sandPixelImage.length == 0 || monkeyLoad.getLoadFinish() != true){
	ctx.font = '50pt Arial';
  ...
  for(let num =0;num<spheres.length;num++){
	...
	for(let num=0;num<monkeys.length;num++){
		...
		moveCubeInfo.orgObject = monkeys[num];
		moveCubeInfo.image = object.image;
		moveCubeInfo.backGroundFlag = object.backGroundFlag;
		moveCubeInfo.backCullingFlag = object.backCullingFlag;
