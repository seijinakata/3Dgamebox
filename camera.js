...
dotLineBufferRegister(triangleVerts[0][0],triangleVerts[1][0],triangleVerts[0][1],triangleVerts[1][1],0,255,255,255,triangle);//0から1
dotLineBufferRegister(triangleVerts[1][0],triangleVerts[2][0],triangleVerts[1][1],triangleVerts[2][1],0,255,255,255,triangle);//1から2
dotLineBufferRegister(triangleVerts[2][0],triangleVerts[0][0],triangleVerts[2][1],triangleVerts[0][1],0,255,255,255,triangle);//2から3

triangleRasterize(triangle,1,255,0,0,255,SCREEN_SIZE_H,SCREEN_SIZE_W);
