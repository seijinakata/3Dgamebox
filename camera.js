...
var mainLoopId = setInterval(function(){
  ...
  //上面
  Polygones.push(new Polygon(cubes[4],cubes[5],cubes[0],'rgb(255,255,0)'));
  Polygones.push(new Polygon(cubes[1],cubes[0],cubes[5],'rgb(255,255,0)'));
  //下面
  Polygones.push(new Polygon(cubes[3],cubes[2],cubes[7],'rgb(255,255,0)'));
  Polygones.push(new Polygon(cubes[6],cubes[7],cubes[2],'rgb(255,255,0)'));
  //後面
  Polygones.push(new Polygon(cubes[5],cubes[4],cubes[6],'rgb(255,255,0)'));
  Polygones.push(new Polygon(cubes[7],cubes[4],cubes[6],'rgb(255,255,0)'));
  //左側面
  Polygones.push(new Polygon(cubes[4],cubes[0],cubes[7],'rgb(255,255,0)'));
  Polygones.push(new Polygon(cubes[3],cubes[7],cubes[0],'rgb(255,255,0)'));
  //右側面
  Polygones.push(new Polygon(cubes[1],cubes[5],cubes[2],'rgb(255,255,0)'));
  Polygones.push(new Polygon(cubes[6],cubes[2],cubes[5],'rgb(255,0,0)'));
