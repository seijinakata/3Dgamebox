...
let cube2 = new Object(orgCubeVerts,-0,-1,5.0,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
...
let cube4 = new Object(orgCubeVerts,-0.2,-1.4,5.4,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
let cube5 = new Object(orgCubeVerts,0,-0.4,5,0,0,0,false,true,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
...
var mainLoopId = setInterval(function(){
  ...
  for(let j=1;j<cubes.length;j++){
    ...
    for(let i=cubes.length;i<moveObjects.length;i++){
        ...
        if(object.centerObjY<moveObjects[i].centerObjY){
          object.preGravityCollision = AABBcollision(object,moveObjects[i]);
            if(object.preGravityCollision == true){
              ...
              projectionList = setProjectionMatrix(planes[downIndex-cubes.length],Cz,Cx,upObjectY,CRotZ,CRotX,CRotY);
              ...
              CRz = projectionList.CRz;
              distance_from_Obj_to_Camera = projectionList.distance_from_Obj_to_Camera;
              moveCubeInfo = cameraModel(planes[downIndex-cubes.length],distance_from_Obj_to_Camera,ORz,ORy,ORx,CRz,CRy,CRx,Extension,offset);
  ...
  for(let j=1;j<cubes.length;j++){
    ...
    for(let i=0;i<cubes.length;i++){
     ...
     if(object.gravityCollision == false){
        object.orgObject.centerObjY += 0.01;
     } 
  }
    ...
    if((40<=CRotY && CRotY<=120) || (220<=CRotY && CRotY<=320)){
      ...
      for(let i=0;i<moveObjects.length;i++){
       ...
       while(true){
        ...
        for(;i<moveObjects.length;i++){
          if(drawObjectNum != i){
            console.log(upDownSerch(moveObjects[drawObjectNum],moveObjects[i]))
          console.log(0,Math.abs(moveObjects[0].centerObjY-Cy))
          console.log(1,Math.abs(moveObjects[1].centerObjY-Cy))
            if((moveObjects[i].isDraw == false) && upDownSerch(moveObjects[drawObjectNum],moveObjects[i]) 
                 && (Math.abs(moveObjects[i].centerObjY-Cy)>Math.abs(moveObjects[drawObjectNum].centerObjY-Cy))){
              console.log(777)
