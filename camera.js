...
import {pixel,bufferPixelInit,pictureToPixelMap,dotPaint,dotLineBufferRegister,triangleRasterize,texturetransform} from './paint.mjs';
...
affinedTexture = texturetransform(1,-0.3,1,0.7,SCREEN_SIZE_H/2-catPixelImage.length/2,SCREEN_SIZE_W/2,catPixelImage,SCREEN_SIZE_H,SCREEN_SIZE_W);
