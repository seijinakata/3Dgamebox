...
let cube1 = new Object(orgCubeVerts,-1.5,0,4,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');
...
let cube3 = new Object(orgCubeVerts,1.5,0,6,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F0473fc3d55a213710b0b024a2fdc3a51.jpg?v=1620968464541');

let plane1 = new Object(orgPlaneVerts,0,0,8,0,0,0,'https://cdn.glitch.com/6efb404c-071d-4250-b26b-2bdeba7c6ed2%2F60a394aea133b1704cfd2d6e5db73.jpg?v=1623239051320');
...
var mainLoopId = setInterval(function(){
  ...
  while(true){
    ...
    for(let i=0;i<moveObjects.length;i++){
      if(!(moveObjects[i].isdraw) && moveObjects[i].centerObjZ>=temoObjCenterZ){
        temoObjCenterZ = moveObjects[i].centerObjZ;
      }
    }
    console.log(temoObjCenterZ)
