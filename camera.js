...
class Polygon{
  constructor(Pos1,Pos2,Pos3,image){
    ...
    this.image = image;
    this.ZPosition = (this.moveVertices[0][2] + this.moveVertices[1][2] + this.moveVertices[2][2])/3;
  }
  draw(con){
...
var mainLoopId = setInterval(function(){
  ...
  //後面
  Polygones.push(new Polygon(cubes[4],cubes[7],cubes[5],null));
  Polygones.push(new Polygon(cubes[5],cubes[6],cubes[7],null));
  //Polygones.push(new Polygon(cube.dotMovePos[4],cube.dotMovePos[5],cube.dotMovePos[6],cube.dotMovePos[7],4,cube.image));
  //左側面
  Polygones.push(new Polygon(cubes[4],cubes[0],cubes[5],null));
  Polygones.push(new Polygon(cubes[5],cubes[1],cubes[0],null));
  //Polygones.push(new Polygon(cube.dotMovePos[4],cube.dotMovePos[5],cube.dotMovePos[1],cube.dotMovePos[0],4,cube.image));
  //右側面
  Polygones.push(new Polygon(cubes[7],cubes[3],cubes[6],null));
  Polygones.push(new Polygon(cubes[6],cubes[2],cubes[3],null));
  //Polygones.push(new Polygon(cube.dotMovePos[7],cube.dotMovePos[6],cube.dotMovePos[2],cube.dotMovePos[3],4,cube.image));
  //前面
  Polygones.push(new Polygon(cubes[0],cubes[3],cubes[1],null));
  Polygones.push(new Polygon(cubes[1],cubes[2],cubes[3],null));
  //Polygones.push(new Polygon(cube.dotMovePos[0],cube.dotMovePos[1],cube.dotMovePos[2],cube.dotMovePos[3],4,cube.image));
  //上面
  Polygones.push(new Polygon(cubes[4],cubes[7],cubes[0],null));
  Polygones.push(new Polygon(cubes[0],cubes[3],cubes[7],null));
  //Polygones.push(new Polygon(cube.dotMovePos[4],cube.dotMovePos[0],cube.dotMovePos[3],cube.dotMovePos[7],4,cube.image));
  //下面
  Polygones.push(new Polygon(cubes[5],cubes[6],cubes[1],null));
  Polygones.push(new Polygon(cubes[1],cubes[2],cubes[6],null));
